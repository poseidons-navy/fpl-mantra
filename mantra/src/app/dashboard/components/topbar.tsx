...
function DashboardTopBar() {
  ...
  return (
    <div className={clsx("flex flex-row items-center justify-between w-full border-b-[1px] border-b-neutral-50  px-5 py-5 bg-gradient-to-r from-sky-400 to-sky-100")}>
        <div className="flex flex-row items-center justify-start w-full space-x-2">
            ...
            <span className="text-md opacity-70 ">
                (UserAddress) { /*session?.data?.user?.username*/ }
            </span>
        </div>
