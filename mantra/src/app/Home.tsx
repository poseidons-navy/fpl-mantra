        ...
        >
          <div className="w-full h-2/4 md:h-full md:w-2/5 flex flex-col justify-center items-center md:items-start gap-8">
            ...
            <p className="max-w-md text-sm md:text-base text-zinc-500">
              FPL Mantra is a platform that allows users to win prizes from
              league tournaments they set on fpl league.
            </p>
            <div className="w-full flex items-center justify-center md:justify-start gap-4">
              <Link href="/dashboard">
                <button className="w-48 h-12 text-sm sm:text-base rounded bg-black text-white hover:bg-sky-200 hover:text-black transition-colors">
                  Join Now!
                </button>
              </Link>
              <p className="max-w-md text-sm md:text-base text-zinc-500">
                ...
                <Link
                  className="text-black hover:text-fuchsia-700 "
                  href="/dashboard"
                >
                  Log in
                </Link>
          ...
          <div className="w-full h-2/4 md:h-full md:w-3/5 flex items-center justify-center relative -z-10"></div>
        </header>
      </main>
    </WalletContextProvider>
  );
